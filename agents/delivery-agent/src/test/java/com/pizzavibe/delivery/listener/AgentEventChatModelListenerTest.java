...
import com.pizzavibe.delivery.client.AgentEventClient;
import com.pizzavibe.delivery.model.AgentEvent;
...
class AgentEventChatModelListenerTest {
    ...
    void onRequestShouldSendRequestEventWithUserMessage() {
        ChatRequest chatRequest = ChatRequest.builder()
                .messages(List.of(UserMessage.from("Deliver margherita pizza to 123 Main St")))
                .build();
        ...
        assertEquals("Deliver margherita pizza to 123 Main St", event.text());
    ...
    void onResponseShouldSendResponseEventWithAiMessage() {
        ...
        ChatResponse chatResponse = ChatResponse.builder()
                .aiMessage(AiMessage.from("Delivery confirmed for order-123"))
                .build();
        ...
        assertEquals("Delivery confirmed for order-123", event.text());
        assertEquals("order-123", event.orderId());
    }
