package com.pizzavibe.cooking.config;

import com.pizzavibe.cooking.agent.CookingAgentExecutor;
...
public class A2AServerConfig {
    ...
    @Bean
    public JSONRPCHandler jsonRPCHandler(AgentCard agentCard, CookingAgentExecutor agentExecutor) {
